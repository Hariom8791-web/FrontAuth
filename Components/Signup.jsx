...
<section class="signup">
    <div class="container">
        <div class="signup-content">
            <div class="signup-form">
                ...
                <form  class="register-form" id="register-form" onSubmit={handleSubmit}>
                    ...
                    <button className="form-submit" id="signup" style={{ color: "white", textDecoration: "none" }}><a href="https://gulal-revolution.vercel.app">Home</a></button>
                </form>
            </div>
        ...
        <h4>This PROJECT DEVELOPED  by Hari Om singh Contact for Work ( https://wa.me//7599028269) <a href="https://github.com/Hariom8791-web">https://github.com/Hariom8791-web</a> </h4>
